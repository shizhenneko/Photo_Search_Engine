...
class OpenRouterVisionLLMService(VisionLLMService):
    ...
    def generate_description(self, image_path: str) -> str:
        ...
        """
        prompt = (
            "你是照片索引专家。请为这张图片生成一段用于语义检索的中文描述。\n\n"
            "## 输出要求\n\n"
            "**描述长度**：50-200字，自然段落形式\n\n"
            "**NEVER（绝对禁止）**：\n"
            "- 不要推测或提及拍摄时间（如\"下午\"、\"傍晚\"、\"夏天\"、\"周末\"）\n"
            "- 不要描述图片外的信息（如拍摄设备、拍摄者意图）\n"
            "- 不要使用\"这张照片展示了...\"这样的开头\n\n"
            "## 描述流程\n\n"
            "第一步：识别场景类型\n"
            "- 室内/室外\n"
            "- 具体地点（公园、海滩、街道、客厅、办公室等）\n\n"
            "第二步：描述主要主体\n"
            "- 人物：数量、年龄段、着装特征\n"
            "- 物体：类型、颜色、位置关系\n"
            "- 动物：种类、姿态\n\n"
            ...
            "## 示例\n\n"
            "输入：一张公园里小孩放风筝的照片\n"
            "输出：开阔的草坪上，一个穿红色外套的小男孩正在放飞一只蝴蝶形状的风筝。"
            "风筝飞得很高，彩色的尾巴在空中飘动。背景是一排绿树和蓝天白云。"
            "画面色彩鲜艳，充满童趣和活力。\n\n"
            "现在请描述图片："
        )
